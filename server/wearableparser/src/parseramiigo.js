...
parseAmiigo.prototype.manageLogfiles = function(file, callback) {
	...
	var sensorData = '';
	var readStream = fs.ReadStream("wearableparser/src/testdata/" + file);
	...
	readStream.on('close', function () {
 		...
 		var livetextfile = './wearableparser/src/testdata/' + file;
 		var moveoldstring = './wearableparser/src/oldtestdata/' + file;
