...
console.log('accc query fro server influix class');
  ...
  var query = 'SELECT * FROM accelerometer';
	...
	this.liveclient.query(query).then(result => {
//console.log(result);
			callbackIN(result);
	  }).catch(err => {
...
*
*/
influxDB.prototype.queryTimeseriesLight = function(callbackIN) {
