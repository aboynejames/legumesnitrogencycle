...
/**
 * aboynejames added function to core library
 * @param {}  -
 * @param {}
 */
Router.prototype.hopBucketlist = function() {
console.log('new function to hop around from BUCKETs');
//console.log(this._buckets);
//console.log(this._buckets['158']);
//console.log(this._buckets['159']);
